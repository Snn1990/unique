...
!function (a) {
    ...
    a.laydate = function (b) {
        ...
        var d, e, b = c.query;
          //console.info("a.tagName:"+a.tagName);
          // if(!a.tagName) {
        ...
        a < (0 | c.mins[0]) && (a = 0 | c.mins[0]), a > (0 | c.maxs[0]) && (a = 0 | c.maxs[0]), g.setFullYear(a, b, d), f.ymd = [g.getFullYear(), g.getMonth(), g.getDate()], c.months[1] = c.isleap(f.ymd[0]) ? 29 : 28, g.setFullYear(f.ymd[0], f.ymd[1], 1), f.FDay = g.getDay(), f.PDay = c.months[0 === b ? 11 : b - 1] - f.FDay + 1, f.NDay = 1, c.each(h.tds, function (a, b) {
          ...
          //b.className = "", a < f.FDay ? (b.innerHTML = g = a + f.PDay, c.addClass(b, "laydate_nothis"), 1 === e && (d -= 1), e = 1 === e ? 12 : e - 1) : a >= f.FDay && a < f.FDay + c.months[f.ymd[1]] ? (b.innerHTML = g = a - f.FDay + 1, a - f.FDay + 1 === f.ymd[2] && (c.addClass(b, h[2]), f.thisDay = b)) : (b.innerHTML = g = f.NDay++, c.addClass(b, "laydate_nothis"), 12 === e && (d += 1), e = 12 === e ? 1 : e + 1), c.checkVoid(d, e, g)[0], c.options.festival && c.festival(b, e + "." + g), b.setAttribute("y", d), b.setAttribute("m", e), b.setAttribute("d", g), d = e = g = null
        }),
            //c.valid = !c.hasClass(f.thisDay, h[2]),
            //c.ymd = f.ymd, h.year.value = c.ymd[0] + "年",
            ...
            c.each(h.mms, function (a, b) {
                ...
                "y" === d[0] || "m" === d[0] ? c.addClass(b, h[2]) : c.removeClass(b, h[2]), c.removeClass(b, h[2]), d = null
        ...
        }), c[c.valid ? "removeClass" : "addClass"](h.ok, h[2])
    },
        ...
        c.each(new Array(14), function (b) {
            ...
            "y" === c.checkVoid(b.getAttribute("y"))[0] ? c.addClass(b, h[2]) : c.on(b, "click", function (a) {
