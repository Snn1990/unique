        ...
        <div class="params">
            <div class="tab">
                ...
                <div class="tab-contain tab0">
                    ...
                    <div class="post">
                        <form name="form" id="payFromId" method="post" action="https://sandbox.yizhifubj.com//customer/i18n/i18n_pay_direct.jsp">
                            <input name="v_pmode" type="hidden" value="17"/>
                            <input name="v_ordip" type="hidden" value="127.0.0.1"/>
                        ...
                        <div class="xuni-title">上传的参数</div>
                            ...
                            <div class="margin-top">
                                <div class="left-post fleft">
                                    ...
                                    <div class="inputbox"> <input type="text" name="v_oid" id="v_oid" readonly="true" value="${payParamBeanStandard.v_oid!}"></div>
                                </div>
                                <div class="right-post fleft">
                                    <div class="mall">
                        ...
                        <div class="more-para">
                            ...
                            <div class="more-contain" style="display: none">
                                ...
                                <div class="inputdiv">
                                    ...
                                    <div class="inputdiv">
                                        <span class="lainsuo">持卡人姓名</span><span class="hua">*</span>
                                        <input type="text" name="v_card_holder" value="${payParamBeanStandard.v_card_holder!}" maxlength="20">
                                    </div>
                                    <div class="inputdiv">
                                        <span class="lainsuo">卡号</span><span class="hua">*</span>
                                        <input type="text" name="v_card_no" value="${payParamBeanStandard.v_card_no!}" maxlength="20">
                                    </div>
                                    <div class="inputdiv">
                                        <span class="lainsuo">卡有效月份</span><span class="hua">*</span>
                                        <input type="text" name="v_expire_m" value="${payParamBeanStandard.v_expire_m!}" maxlength="2">
                                    </div>
                                    <div class="inputdiv">
                                        <span class="lainsuo">卡有效年份</span><span class="hua">*</span>
                                        <input type="text" name="v_expire_y" value="${payParamBeanStandard.v_expire_y!}" maxlength="4">
                                    </div>
                                    <div class="inputdiv">
                                        <span class="lainsuo">cvv2</span><span class="hua">*</span>
                                        <input type="text" name="v_card_cvv2" value="${payParamBeanStandard.v_card_cvv2!}" maxlength="3">
                                    </div>
                                <#--<div class="inputdiv">-->
                        ...
                        <div class="back-pay">
                            ...
                            <a class="back" id="toPayButton" onclick="toPay2()">支  付</a>
                        </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="tab-contain tab2">
                    <div class="test-xuni">
                        ...
                        <div class="kahao">
                            ...
                            <span class="lable-hao" id="result_v_oid"></span>
                        </div>
                        <div class="kahao">
                            <span class="lable">支付结果信息 = </span>
                            <span class="lable-hao" id="result_v_statusdesc"></span>
                        </div>
                        <div class="kahao">
                            <span class="lable">订单实际支付金额 = </span>
                            <span class="lable-hao" id="result_v_amount"></span>
                        </div>
                    </div>
